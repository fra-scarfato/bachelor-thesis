...
\begin{figure}[H]
    \begin{tikzpicture}
        ...
        \end{abstractclass}
        \begin{abstractclass}[text width=6.5cm]{SimplifyingGeneratingInference}{0,-5}
            \inherit{InferenceEngine}
            \operation[0]{+ generateSimplify(premise : Clause*) : ClauseGenerationResult}
        \end{abstractclass}
        \begin{class}[text width=7cm]{GeneratingInferenceEngine}{5,-8.5}
        ...
        \end{class}
        \begin{class}[text width=7cm]{CompositeGIE}{5,-12.5}
        ...
        \end{class}
        \begin{class}[text width=7.5cm]{CompositeSGI}{-5,-8.5}
            \inherit{SimplifyingGeneratingInference}
